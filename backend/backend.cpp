...
void Backend::AddUser(const User &user) { this->uid_2_users_.insert({user.uid, user}); }

void Backend::AddChatRoom(const ChatRoom &room) { this->uid_2_room_[room.uid] = room; }
